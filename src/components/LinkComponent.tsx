  ...
  return (
    <>
      <div className="w-full flex justify-center px-5">
        <div className="rounded-3xl bg-whiteSmoke w-full h-[294px] flex flex-col items-center p-5 py-7 shadow-[9px_9px_5px_rgba(128,128,128,0.2)]">
          <div className="flex flex-col justify-center mb-[10px] gap-2.5 w-full">
            ...
            <a href="https://m.shop.kt.com:444/m/mobile/products.do?=&category=mobile&pplId=0947">
              <button className="bg-black w-full text-sm font-medium text-white rounded-md h-10">
                핸드폰 보러가기
              </button>
            </a>

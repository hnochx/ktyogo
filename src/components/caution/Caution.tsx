  ...
  return (
    <div className="h-full mt-[12vw]">
      ...
      <ul className="mt-[4vw]">
        <div>
          <div>
            <li className="w-full h-[15vw] bg-[#E9E9E9] border-t-[0.4vw] border-[#cbcbcb] flex items-center gap-2">
              <h2 className="font-bold pl-[4vw] text-[4.5vw]">※ 요고 요금제 유의사항</h2>
              <Image
                src={openSections.section1 ? close : open}
                alt="Toggle"
                className="w-[5vw] h-[4vw] ml-[35vw]"
          ...
          >
            <div className="text-[3vw] p-[6vw] list-disc">
              ...
              <li>이용 가능한 결합 할인 서비스는 결합상품 페이지 및 결합 약관을 참고하시기 바랍니다.</li>
              <li>
                초이스/플러스 혜택은 요금제 가입 일자 기준으로 최대 24개월간 제공되며, ‘나중에 선택하기‘ 선택 시에도
                24개월 혜택 기간에 포함됩니다.
              </li>
              <li>초이스/플러스 혜택은 각 월 1회 변경 가능합니다.</li>
              <li>
                요금제에 기본으로 제공되거나 함께 사용할 수 있는 부가/기타 서비스의 상세 내용은 KT닷컴 내 서비스별 안내
                페이지를 참고하세요.
              </li>
              <li>이용하시는 요금제에 따라 초이스, 플러스 혜택이 제공됩니다.</li>
            </div>
          </div>
        </div>
        ...
        <div>
          <div>
            <li className="w-full h-[15vw] bg-[#E9E9E9] border-t-[0.4vw] border-[#cbcbcb] flex items-center">
              <h2 className="font-bold pl-[4vw] text-[4.5vw]">※ 스타벅스 커피 이벤트 유의사항</h2>
              <Image
                src={openSections.section2 ? close : open}
                alt="Toggle"
                className="w-[5vw] h-[4vw] ml-[17.5vw]"
          ...
          >
            <div className="text-[3vw] p-[6vw] list-disc">
              ...
              <li>기본적으로 선택하는 쿠폰팩 외에 추가로 증정하는 이벤트입니다.</li>
              <li>
